...
home = str(Path.home())
FEEDBACKS = os.path.join(home,'/home/samueletremo/RO_browser/simulazione_esame/browser_feedback_log/feedbacks.yaml') # yaml contenente i feedback suddivisi per esercizio e per task
FEEDBACK_SAVED_LOG = os.path.join(home,'/home/samueletremo/RO_browser/simulazione_esame/browser_feedback_log/feedback_saved_log.yaml')  # yaml contenente i feedback salvati suddivisi per esercizio e per task
POINTS_YAML = '/home/samueletremo/RO_browser/simulazione_esame/browser_feedback_log/points.yaml'  # yaml contenente i punti suddivisi per esercizio e per task
SAVED_SCORES = '/home/samueletremo/RO_browser/simulazione_esame/browser_feedback_log/saved_scores.yaml'  # yaml contenente i punti relativi agli esercizi salvati suddivisi per esercizio e per task
